			...
			<div class="col-md-12">
				<div class="form-group">
					...
					<input type="text" id="title" name="title" placeholder="<?php echo trans('news.title'); ?>"
						class="form-control <?php echo  !empty($title)?'is-invalid':'' ; ?>" value="<?php echo old('title'); ?>" />
				</div>
			</div>
			<div class="col-md-6">
				<div class="form-group">
			...
			<div class="col-md-12">
				<div class="form-group">
					...
					<textarea name="content" id="content" placeholder="<?php echo trans('news.content'); ?>"
						class="form-control <?php echo  !empty($content)?'is-invalid':'' ; ?>"><?php echo old('content'); ?></textarea>
				</div>
			</div>
		</div>
