			...
			<div class="col-md-6">
				<div class="form-group">
					...
					<input type="text" name="name" placeholder="<?php echo trans('user.name'); ?>"
						class="form-control <?php echo  !empty($name)?'is-invalid':'' ; ?>" value="<?php echo old('name'); ?>" />
				</div>
			</div>
			...
			<div class="col-md-6">
				<div class="form-group">
					...
					<input type="text" name="email" placeholder="<?php echo trans('user.email'); ?>"
						class="form-control <?php echo  !empty($email)?'is-invalid':'' ; ?>" value="<?php echo old('email'); ?>" />
				</div>
			</div>
			...
			<div class="col-md-6">
				<div class="form-group">
					...
					<input type="text" name="mobile" placeholder="<?php echo trans('user.mobile'); ?>"
						class="form-control <?php echo  !empty($mobile)?'is-invalid':'' ; ?>" value="<?php echo old('mobile'); ?>" />
				</div>
			</div>
