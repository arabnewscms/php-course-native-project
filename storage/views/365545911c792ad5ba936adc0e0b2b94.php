  ...
  <form method="post" action="<?php echo aurl('categories/create'); ?>" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="form-group">
          ...
          <textarea name="description" placeholder="<?php echo trans('cat.desc'); ?>"  class="form-control <?php echo  !empty($description)?'is-invalid':'' ; ?>"><?php echo old('description'); ?></textarea>
         </div>
        </div>
    </div>
