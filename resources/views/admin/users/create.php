			...
			<div class="col-md-6">
				<div class="form-group">
					...
					<input type="text" name="name" placeholder="{{trans('user.name')}}"
						class="form-control {{ !empty($name)?'is-invalid':'' }}" value="{{old('name')}}" />
				</div>
			</div>
			...
			<div class="col-md-6">
				<div class="form-group">
					...
					<input type="text" name="email" placeholder="{{trans('user.email')}}"
						class="form-control {{ !empty($email)?'is-invalid':'' }}" value="{{old('email')}}" />
				</div>
			</div>
			...
			<div class="col-md-6">
				<div class="form-group">
					...
					<input type="text" name="mobile" placeholder="{{trans('user.mobile')}}"
						class="form-control {{ !empty($mobile)?'is-invalid':'' }}" value="{{old('mobile')}}" />
				</div>
			</div>
